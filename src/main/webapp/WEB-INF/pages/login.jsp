...
<!-- saved from url=(0209)https://passport.meituan.com/account/unitivelogin?service=www&continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fbj.meituan.com%252Fs%252F&mtt=1.s%2Fdefault.0.0.ii8cd1h6 -->
<html>
<head>
    ...
    <link rel="canonical" href="./登录 _ 美团网_files/登录 _ 美团网.html">
    <meta name="keywords" content="美团,登录,注册,美团登录,美团注册">

    <title>登录 | 美团网</title>

    <link rel="stylesheet" type="text/css" href="css/login/login1">
    ...
    <script async="" src="js/login/jsb"></script>
    <script type="text/javascript">
...
<body class="pg-unitive-login theme--www" id="dummybodyid">
...
<div class="site-body-wrapper">
    <div class="site-body cf">
        <div class="promotion-banner">
            <img src="images/login/1" width="480" height="370" alt="美团网">
        </div>

        <div class="login-section" data-params="{&quot;service&quot;:&quot;www&quot;,&quot;isDialog&quot;:false }">
            <form id="J-normal-form"
                  action="https://passport.meituan.com/account/unitivelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fbj.meituan.com%252Fs%252F"
        ...
        <span class="login-type" data-mtevent="login.mobile.switch">
            ...
            账号登录
                ...
                <div class="form-field form-field--captcha" style="display:none">
                    <input type="text" id="captcha" class="f-text" name="captcha" placeholder="验证码" autocomplete="off">
                    <img height="36" width="72" class="signup-captcha-img" id="signup-captcha-img"
                         src="./登录 _ 美团网_files/captcha">
                ...
                <div class="form-field form-field--auto-login cf">
                    <a tabindex="-1"
                       href="https://passport.meituan.com/account/retrievepassword?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fbj.meituan.com%252Fs%252F"
                ...
                <div class="form-field form-field--ops">
                    ...
                    <input type="hidden" name="fingerprint" class="J-fingerprint" value="0-6-1-">
                    <input type="hidden" name="csrf" value="61BrSmD4-6b0Y_NStUSrEiiDts7mvBsaPaPI">
                    <input data-mtevent="login.normal.submit" type="submit" class="btn" name="commit" value="登录">
                </div>
                <p class="signup-guide">还没有账号？<a
                        href="/account/unitivesignup"
                        target="_top">免费注册</a></p>
            </form>

            <form id="J-mobile-form"
                  action="https://passport.meituan.com/account/unitivemobilelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fbj.meituan.com%252Fs%252F"
        ...
        <span class="login-type login-type--normal" data-mtevent="login.normal.switch">
            <a id="J-normal-link" href="./登录 _ 美团网_files/登录 _ 美团网.html">
                普通方式登录
                <i></i>
            </a>
            账号登录
                ...
                <div class="form-field form-field--auto-login cf">
                    <a tabindex="-1"
                       href="https://passport.meituan.com/account/retrievepassword?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fbj.meituan.com%252Fs%252F"
                       target="_top" class="forget-password">忘记密码？</a>
                    <input type="checkbox" value="1" name="auto_login" id="mobile-autologin"
                           class="f-check ui-checkbox">
                ...
                <p class="J-treaty-block treaty-block" style="display:none">
                    提示：
                    未注册美团账号的手机号，登录时将自动注册美团账号，且代表您已同意<a href="http://www.meituan.com/about/terms" target="_blank">《美团网用户协议》</a>
                </p>
            </form>
            ...
            <div class="oauth-wrapper">
                ...
                <div class="oauth cf">
                    <a class="oauth__link oauth__link--qq" href="https://passport.meituan.com/account/connect/tencent"
                       data-mtevent="{&quot;la&quot;:&quot;oauth/qq&quot;}" target="_blank"></a>
                    <a class="oauth__link oauth__link--alipay"
                       href="https://passport.meituan.com/account/connect/alipay"
                       data-mtevent="{&quot;la&quot;:&quot;oauth/aplipay&quot;}" target="_blank"></a>
                    <a class="oauth__link oauth__link--weibo" href="https://passport.meituan.com/account/connect/sina"
...
<footer class="footer">
    <div class="site-info-nav cf">
        <ul>
            <li class="first"><a rel="nofollow" href="http://meituan.com/about/">关于美团</a></li>
            <li><a rel="nofollow" href="http://meituan.com/commitment/">美团承诺</a></li>
            <li><a rel="nofollow" href="http://www.hotjob.cn/wt/meituan/web/index?brandCode=meituan" "="">加入我们</a></li>
            <li><a rel="nofollow" href="http://zhaoshang.meituan.com/">商家入驻</a></li>
            <li><a rel="nofollow" href="http://meituan.com/help/faq">帮助中心</a></li>
            <li class="last"><a href="http://meituan.com/mobile">美团手机版</a></li>
        </ul>
        <a class="site-info-nav__commitment" href="http://meituan.com/commitment/">
            <img width="276" height="24" src="./登录 _ 美团网_files/footer-commitment.png" alt="美团保障">
        </a>
    </div>
    <div class="copyright">
        <p>
...
<span id="csrf" style="display:none">61BrSmD4-6b0Y_NStUSrEiiDts7mvBsaPaPI</span>

<script src="js/login/login2"></script>
<script src="js/login/login3"></script>
