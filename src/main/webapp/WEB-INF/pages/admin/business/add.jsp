...
<script>
    function add() {
        ...
        $.post("/admin/business/saveorupdate", postData, function (returnData) {
            if (returnData.status == 200) {
//                        $.messager.alert("保存成功", "保存成功");
                openTab('商家列表', "/admin/business/tolist")
            } else {
    ...
    <div data-options="region:'center',split:true">
        <form id="ff" method="post">
            ...
            <table cellpadding="5">
                ...
                <tr>
                    <td>搜索关键字</td>
                    <td><input class="easyui-textbox" style="width: 300px" type="text" name="searchKey"
                               data-options="required:true"
                               value="${business.searchKey}">
                    </td>
                </tr>
            </table>
        </form>
